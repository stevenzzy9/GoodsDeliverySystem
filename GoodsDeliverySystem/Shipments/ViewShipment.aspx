<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewShipment.aspx.cs" Inherits="GoodsDeliverySystem.Shipments.ViewShipment" %>
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-md-10">
                            ...
                            <asp:SqlDataSource ID="gdsDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GoodsDeliveryConnectionString %>" SelectCommand="ShipmentDetails" SelectCommandType="StoredProcedure">
                                <SelectParameters>
                                    <asp:QueryStringParameter Name="id" QueryStringField="shipment" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </div>
                        <div class="col-md-10">
                            <asp:GridView ID="gvShippingUpdates" runat="server" AllowSorting="True" RowStyle-Wrap="false"
                                AutoGenerateColumns="False" DataSourceID="gdsDataSource2" CssClass="table table-bordered" AllowPaging="True">
                                <AlternatingRowStyle BackColor="#EFEFEF" />
                                <RowStyle Wrap="False" />
                                <SelectedRowStyle BackColor="#CDCDEF" />
                                <Columns>
                            ...
                            <asp:SqlDataSource ID="gdsDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:GoodsDeliveryConnectionString %>" SelectCommand="ShipmentStatusHistory" SelectCommandType="StoredProcedure">
                                <SelectParameters>
                                    <asp:QueryStringParameter Name="id" QueryStringField="shipment" />
                                </SelectParameters>
                            </asp:SqlDataSource>
