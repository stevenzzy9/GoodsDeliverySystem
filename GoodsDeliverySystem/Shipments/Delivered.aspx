<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Delivered.aspx.cs" Inherits="GoodsDeliverySystem.Shipments.Delivered" %>
        ...
        <div class="col-md-11">
            <section id="selectTruckForm">
                <div class="form-horizontal">
                    <h3>Update Shipment Status: Delivered</h3>
                    <br />
                                        ...
                                        <div class="col-md-10">
                                              <asp:GridView ID="gvShipments" runat="server" AllowSorting="True" RowStyle-Wrap="false"
                                                ...
                                                <SelectedRowStyle BackColor="#CDCDEF" />
                                                  <EmptyDataTemplate>
                                                      There are no shipments out for local delivery.
                                                  </EmptyDataTemplate>
                                                  <Columns>
                                             ...
                                             <asp:SqlDataSource ID="gdsDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GoodsDeliveryConnectionString %>" SelectCommand="ShipmentsOutForLocal" SelectCommandType="StoredProcedure"></asp:SqlDataSource>          
                                        </div>                 
                                    </div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                           <br />
                             <asp:UpdatePanel ID="ConfirmationPanel" runat="server" Visible="false">
                                <ContentTemplate>
                                    ...
                                    <div class="form-group">
                                        <asp:Label ID="Label1" runat="server" CssClass="col-md-offset-1 control-label">Has this shipment been delivered?</asp:Label><br />
                                    </div>
                                    <div class="form-group">
