<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DispatchTruck.aspx.cs" Inherits="GoodsDeliverySystem.Transportation.DispatchTruck" %>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-10">
                                            <asp:GridView ID="gvShipments" runat="server" AllowSorting="True" RowStyle-Wrap="false"
                                                ...
                                                <EmptyDataTemplate>
                                                    There are no trucks with shipments loaded on them to dispatch.
                                                </EmptyDataTemplate>
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="PercentWeight" HeaderText="% Weight Capacity" SortExpression="PercentWeight">
                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="PercentVolume" HeaderText="% Volume Capacity" SortExpression="PercentVolume">
                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="FirstDate" HeaderText="Date 1st Shipment Added" SortExpression="FirstDate">
                                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                    </asp:BoundField>
                                                </Columns>
                                            </asp:GridView>
                                            <asp:SqlDataSource ID="gdsDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GoodsDeliveryConnectionString %>" SelectCommand="TruckSelectToDispatch" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                                        </div>
                                    </div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
